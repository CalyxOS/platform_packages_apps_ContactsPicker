...
/** Represents the loading status and availability of user profiles. */
sealed interface PickerUserState {
    data object Loading : PickerUserState

    /** State holding the available users/profiles and the current selection. */
    data class Success(
        /**
         * Map of user ID to [UserProfile] for all profiles associated with the current foreground
         * user. This includes the personal profile, work profile, and any other associated
         * profiles.
         */
        val userIdToAvailableUsersMap: Map<Int, UserProfile>,
        /**
         * The user ID of the currently active profile in the picker UI. This determines contacts
         * from which user-id are currently displayed to the human user.
         */
