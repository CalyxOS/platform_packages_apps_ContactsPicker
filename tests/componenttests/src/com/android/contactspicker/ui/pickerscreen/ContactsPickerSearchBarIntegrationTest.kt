 ...
 * this test uses ActivityScenario and invokes the
 * [com.android.contactspicker.ContactsPickerActivity] to test the search bar behaviour in the
 * activity's compose hierarchy.
 */
